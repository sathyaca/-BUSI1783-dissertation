# ============================================================
# TRUSTPILOT SCRAPER - FINAL COMPLETE VERSION
# Final brands:
# Ethical Fashion: Finisterre, Lucy & Yak, Rapanui, Seasalt Cornwall
# Fast Fashion: Primark, ASOS, Boohoo, Missguided
# ============================================================
...
brands = {
    ...
    "Seasalt Cornwall": "seasaltcornwall.com",
...
raw_path = r"D:\proposal\trustpilot_raw_final.csv"
...
clean_path = r"D:\proposal\trustpilot_clean_final.csv"
...
reply_check = df["Text"].str.contains(
    "thank you for your review|thanks for your review|kind regards|"
    "customer service team|customer care team|please contact|"
    "we are sorry|we're sorry|we apologise|we apologize",
    case=False,
    na=False
).sum()
print(reply_check)
...
plot_path = r"D:\proposal\summary_final.png"
